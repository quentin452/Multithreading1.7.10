...
public class NoiseGeneratorPerlinTwo extends NoiseGenerator {
    ...
    public NoiseGeneratorPerlinTwo(Random p_i45470_1_, int p_i45470_2_) {
        this.field_151602_b = p_i45470_2_;
        this.field_151603_a = new NoiseGeneratorSimplexTwo[p_i45470_2_];

        for (int j = 0; j < p_i45470_2_; ++j) {
            this.field_151603_a[j] = new NoiseGeneratorSimplexTwo(p_i45470_1_);
        }
    }
    ...
    public double[] func_151600_a(double[] p_151600_1_, double p_151600_2_, double p_151600_4_, int p_151600_6_,
        ...
        for (int l = 0; l < this.field_151602_b; ++l) {
            this.field_151603_a[l].func_151606_a(
                p_151600_1_,
                p_151600_2_,
                p_151600_4_,
                p_151600_6_,
