...
public enum Mixin implements IMixin {
    ...
    common_cofhcore_MixinCommandKillAll(Side.COMMON,
        require(TargetedMod.COFHCORE).and(m -> OptimizationsandTweaksConfig.enableMixinCommandKillAll),
        "cofhcore.MixinCommandKillAll"),
