...
public class MixinClientProxy {
    ...
    /**
     * @author quentin452
     * @reason Fix "java.lang.NullPointerException: Unexpected error" caused by onKeypress from the ClientProxy class of the Angelica Mod.
     * This issue appears when the Dynamic Light mod and Falsetweaks are installed, and the Falsetweaks message suggests to "Remove Dynamic Light mod because Falsetweaks already has one built in."
     */
